...
= Sistema Bancário para Testes com JUnit 5 image:https://img.shields.io/github/workflow/status/Wellikson/sistema-bancario/maven[GitHub Workflow Status].

== Relatório de cobertura de código.

image::https://github.com/Wellikson/sistema-bancario/blob/master/relatorio.png[]
